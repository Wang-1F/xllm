...
class CustomMaskAttentionImpl : public torch::nn::Module {
 public:
  CustomMaskAttentionImpl() = default;
  CustomMaskAttentionImpl(const ModelArgs& args,
...
TORCH_MODULE(CustomMaskAttention);

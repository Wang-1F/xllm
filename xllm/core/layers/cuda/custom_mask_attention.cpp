...
torch::Tensor CustomMaskAttentionImpl::forward(
    ...
    KVCache& kv_cache) {
  MTGR_NVTX_RANGE(2, "MTGR/attention/custom_mask_forward");
  ...
  torch::Tensor qkv;
  {
    MTGR_NVTX_RANGE(2, "MTGR/attention/qkv_proj");

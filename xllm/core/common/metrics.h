...
DECLARE_COUNTER(mtgr_cache_policy_requests_total);
DECLARE_COUNTER(mtgr_cache_admitted_requests_total);
DECLARE_COUNTER(mtgr_cache_skipped_requests_total);
DECLARE_COUNTER(mtgr_cache_runtime_admission_requests_total);
DECLARE_COUNTER(mtgr_cache_high_value_requests_total);
DECLARE_COUNTER(mtgr_cache_low_value_requests_total);
DECLARE_COUNTER(mtgr_cacheable_tokens_total);
DECLARE_COUNTER(mtgr_writeback_tokens_total);
DECLARE_COUNTER(mtgr_estimated_cache_blocks_total);
DECLARE_COUNTER(mtgr_high_value_matched_prefix_tokens_total);
DECLARE_COUNTER(mtgr_low_value_matched_prefix_tokens_total);
DECLARE_COUNTER(mtgr_dynamic_admission_requests_total);
DECLARE_COUNTER(mtgr_dynamic_admission_admitted_requests_total);
DECLARE_COUNTER(mtgr_dynamic_admission_skipped_requests_total);
DECLARE_COUNTER(mtgr_dynamic_admission_admitted_tokens_total);
DECLARE_COUNTER(mtgr_dynamic_admission_skipped_tokens_total);
DECLARE_COUNTER(mtgr_rha_admission_requests_total);
DECLARE_COUNTER(mtgr_rha_admission_pressure_requests_total);
DECLARE_COUNTER(mtgr_rha_admission_reuse_evidence_requests_total);
DECLARE_COUNTER(mtgr_rha_admission_entity_id_requests_total);
DECLARE_COUNTER(mtgr_rha_admission_entity_hot_skip_candidates_total);
DECLARE_COUNTER(mtgr_rha_admission_skipped_requests_total);
DECLARE_COUNTER(mtgr_rha_admission_skipped_tokens_total);
DECLARE_COUNTER(mtgr_rha_admission_admitted_requests_total);
DECLARE_COUNTER(mtgr_rha_admission_admitted_tokens_total);

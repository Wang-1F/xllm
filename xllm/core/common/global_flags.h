...
DECLARE_string(mtgr_kv_cache_policy);
DECLARE_string(mtgr_kv_cache_value_fn);
DECLARE_int32(mtgr_kv_cache_prefix_len_threshold);
DECLARE_double(mtgr_rha_pressure_free_block_ratio);
DECLARE_int32(mtgr_rha_min_reuse_count);
DECLARE_int32(mtgr_rha_cold_prefix_len_threshold);
DECLARE_int32(mtgr_rha_entity_hot_skip_min_seen);
DECLARE_uint64(mtgr_rha_state_max_entries);

...
DEFINE_COUNTER(mtgr_cache_policy_requests_total,
               "Total MTGR requests evaluated by KV-cache policy");
DEFINE_COUNTER(mtgr_cache_admitted_requests_total,
               "Total MTGR requests admitted to persistent KV cache");
DEFINE_COUNTER(mtgr_cache_skipped_requests_total,
               "Total MTGR requests skipped by KV-cache admission policy");
DEFINE_COUNTER(mtgr_cache_runtime_admission_requests_total,
               "Total MTGR requests whose persistent KV-cache admission is "
               "decided at runtime");
DEFINE_COUNTER(mtgr_cache_high_value_requests_total,
               "Total MTGR requests classified as high value");
DEFINE_COUNTER(mtgr_cache_low_value_requests_total,
               "Total MTGR requests classified as low value");
DEFINE_COUNTER(mtgr_cacheable_tokens_total,
               "Total MTGR tokens selected for persistent KV-cache storage");
DEFINE_COUNTER(mtgr_writeback_tokens_total,
               "Total MTGR tokens selected for persistent KV writeback");
DEFINE_COUNTER(mtgr_estimated_cache_blocks_total,
               "Estimated MTGR persistent KV-cache blocks requested by policy");
DEFINE_COUNTER(mtgr_high_value_matched_prefix_tokens_total,
               "Total matched prefix tokens for high-value MTGR requests");
DEFINE_COUNTER(mtgr_low_value_matched_prefix_tokens_total,
               "Total matched prefix tokens for low-value MTGR requests");
DEFINE_COUNTER(mtgr_dynamic_admission_requests_total,
               "Total MTGR dynamic length admission decisions");
DEFINE_COUNTER(mtgr_dynamic_admission_admitted_requests_total,
               "Total MTGR dynamic length admission requests admitted");
DEFINE_COUNTER(mtgr_dynamic_admission_skipped_requests_total,
               "Total MTGR dynamic length admission requests skipped");
DEFINE_COUNTER(mtgr_dynamic_admission_admitted_tokens_total,
               "Total MTGR tokens admitted by dynamic length admission");
DEFINE_COUNTER(mtgr_dynamic_admission_skipped_tokens_total,
               "Total MTGR tokens skipped by dynamic length admission");
DEFINE_COUNTER(mtgr_rha_admission_requests_total,
               "Total MTGR reuse-horizon admission decisions");
DEFINE_COUNTER(mtgr_rha_admission_pressure_requests_total,
               "Total MTGR reuse-horizon admission decisions under pressure");
DEFINE_COUNTER(mtgr_rha_admission_reuse_evidence_requests_total,
               "Total MTGR reuse-horizon admission decisions with reuse evidence");
DEFINE_COUNTER(mtgr_rha_admission_entity_id_requests_total,
               "Total MTGR reuse-horizon admission decisions using entity_id");
DEFINE_COUNTER(mtgr_rha_admission_entity_hot_skip_candidates_total,
               "Total MTGR reuse-horizon entity-hot skip candidates");
DEFINE_COUNTER(mtgr_rha_admission_skipped_requests_total,
               "Total MTGR reuse-horizon admission requests skipped");
DEFINE_COUNTER(mtgr_rha_admission_skipped_tokens_total,
               "Total MTGR tokens skipped by reuse-horizon admission");
DEFINE_COUNTER(mtgr_rha_admission_admitted_requests_total,
               "Total MTGR reuse-horizon admission requests admitted");
DEFINE_COUNTER(mtgr_rha_admission_admitted_tokens_total,
               "Total MTGR tokens admitted by reuse-horizon admission");

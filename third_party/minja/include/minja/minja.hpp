...
inline std::shared_ptr<Context> Context::builtins() {
  ...
  globals.set("==", equalto);
  globals.set("defined", simple_function("defined", { "value" }, [](const std::shared_ptr<Context> &, Value & args) -> Value {
      return !args.at("value").is_null();
  }));
  globals.set("undefined", simple_function("undefined", { "value" }, [](const std::shared_ptr<Context> &, Value & args) -> Value {
      return args.at("value").is_null();
  }));
